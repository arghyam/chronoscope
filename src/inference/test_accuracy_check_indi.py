...
def process_images_and_compare():
    ...
    for index, row in tqdm(df.iterrows(), total=len(df), desc="Processing images"):
        ...
        try:
            # Perform inference using direct_recognize_meter_reading from inferenece1.py
            predicted_sequence = direct_recognize_meter_reading(image_path, save_debug_images=False)
    ...
    # Save results to CSV
    output_file = 'dataset/inference_data_check/test_images/inference_results_direct.csv'
